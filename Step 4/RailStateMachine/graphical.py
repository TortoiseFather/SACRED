...
class RailwayOperation(StateMachine):
    ...
    brake_check = brake_change.to(speed_change, cond='is_brake_zero') | brake_change.to(brake_change, cond='brake_not_zero')
    speed_reached = speed_change.to(cruise, cond='is_speed_limit_reached')
    speed_limit_change = cruise.to(brake_change, cond='is_speed_over_limit') | cruise.to(speed_change, cond='is_speed_under_limit')
...
graphs[0].write_png("TrainSMSimple.png")
